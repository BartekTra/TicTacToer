...
const LoginPage = () => {
  ...
  return (
    <div>
      ...
      {import.meta.env.DEV && (
        <div>
          <button onClick={()=>handleTestButton(1)} className=" w-50 h-20 bg-gray-300 outline-1 hover:bg-gray-500">
            1
          </button>
          <button onClick={()=>handleTestButton(2)} className="bg-gray-300  w-50 h-20 outline-1 hover:bg-gray-500">
            2
          </button>
        </div>
      )}
